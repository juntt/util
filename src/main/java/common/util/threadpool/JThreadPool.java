...
public class JThreadPool {
	private volatile static JThreadPool _instance = null;
	private static AtomicReference<ExecutorService> es = new AtomicReference<>();

	private final static String THREADNAME = "JThreadPool";
	private final static String POOL_SIZE = "poolSize";
	private final static String KEEP_ALIVE_TIME = "keepAliveTime";
	private final static String WORK_QUEUE_CAPACITY = "workQueueCapacity";
